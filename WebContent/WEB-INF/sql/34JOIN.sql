...
SELECT * FROM Products JOIN Categories; -- Cartesian Products
SELECT * FROM Products JOIN Categories ON Products.CategoryID = Categories.CategoryID; -- Cartesian Products
